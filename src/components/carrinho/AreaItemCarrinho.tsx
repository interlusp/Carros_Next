...
export default function AreaItemCarrinho(props: AreaItemCarrinhoProps) {
    return (
        <div className="flex items-center gap-5 bg-white-900 rounded-md overflow-hidden">
            ...
            <div className="flex flex-col justify-center flex-1">
                ...
                <div className="flex items-center gap-2 mt-2 text-white-400 text-lg font-bold">
            ...
            <div className="flex gap-2 items-center px-5">
                ...
                <span className="flex px-4 py-2 rounded-md bg-white">{props.item.quantidade}</span>
